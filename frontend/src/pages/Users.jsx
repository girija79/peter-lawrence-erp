  ...
  return (
    <div className="users-page">
      ...
      <div className="page-header users-header">
        <div>
          <div className="page-kicker">ADMINISTRATION · ACCESS CONTROL</div>

          <h1 className="page-title">User Management</h1>

          <p className="page-description">
            Manage accounts and access across the Peter Lawrence legal office.
          </p>
        </div>

        <button className="pl-button pl-button-primary" onClick={handleAddUser}>
      ...
      {showForm && (
        <div className="pl-form-panel">
          <div className="pl-form-header">
            <div>
              <div className="page-kicker">ACCOUNT CONFIGURATION</div>
          ...
          <form onSubmit={handleCreateUser}>
            ...
            <div className="pl-form-actions">
              <button type="submit" className="pl-button pl-button-primary">
                <i
                  className={`bi ${
                    editingUserId ? "bi-check2" : "bi-person-plus"
                  }`}
                ></i>
          ...
          <div className="table-responsive">
            <table className="pl-table">
              ...
              <tbody>
                {users.length === 0 ? (
                  <tr>
                    <td colSpan="5" className="pl-empty-state">
                      <i className="bi bi-people"></i>

                      <strong>No user records</strong>

                      <span>
                        Create the first firm account using the button above.
                      </span>
                    </td>
                  </tr>
                ) : (
